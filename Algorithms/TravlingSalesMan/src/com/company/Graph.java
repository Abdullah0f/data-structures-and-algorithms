...
public class Graph {
    ...
    private class Edge{
        ...
        public Edge(Node from, Node to, int weight) {
            ...
            this.to = to;
            this.weight = weight;
            edges.put(from.toString()+to,this);
        }
    ...
    public void addEdge(String from, String to,int weight){
        ...
        adjacencyList.get(nfrom).add(nto);
        new Edge(nfrom,nto,weight);
        new Edge(nto,nfrom,weight);
    }
...
//        delete the following if you dont want all the graph to be traversed
    ...
    public void DFSi(String starting){
        Node x = nodes.get(starting);
        Set<Node> visited = new HashSet<>();
        ...
        while(!stack.isEmpty()){
            ...
            for (var i: adjacencyList.get(current))
                if (!visited.contains(i))
                    stack.push(i);
        }
    }
    ...
    public int getWeight(String x){
        return edges.get(x).weight;
    }
